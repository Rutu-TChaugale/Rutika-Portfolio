...
export const projectsData = [
    ...
    code: 'https://github.com/Rutu-TChaugale/Inventory_Management_system_frontend',
    demo: 'https://inventory-management-system-fronten-eight.vercel.app/login', 
    image: 'image/Inventory Management System.png', 
     },
     {
    id: 2,
    name: 'Full Stack Job Portal App',
    description:
      'Developed a job portal with secure login, job browsing, filtering, saving, and applying features. Role-based access for job seekers and employers with separate dashboards. Built REST APIs for authentication, job posting, applicant tracking, and notifications.',
    tools: ['Java 17','Spring Boot','Spring Security (JWT)','Hibernate','PostgreSQL','React.js','Vite',],
    role: 'Full Stack Developer',
    code: 'https://github.com/your-github-repo-link', // replace with your repo link
    demo: '', // add live demo if deployed
    image: 'image/JobPortalApp.png', // add screenshot in public/image folder
     },
     {
    id: 3,
    name: 'SR Finance – Vehicle Loan Management System',
    description:
      'Developed loan processing modules with REST APIs for vehicle finance services. Automated eligibility checks, document handling, and online payments. Collaborated with QA team for bug fixing and testing.',
    tools: ['Java 1.8', 'Spring Boot', 'Spring Data JPA', 'MySQL'],
    role: 'Backend Developer',
    code: '', // add GitHub link if available
    demo: '', // add demo link if deployed
    //image: 'image/Finance Loan System.png', // add screenshot in public/image folder
     },
    //  {
    //     id: 2,
    //     name: 'Ubuntu Hardening GUI Application',
